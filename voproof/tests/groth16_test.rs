...
define_test!(test_groth16_test_circuit_scale_128000, gen_test_circ, 128000);
define_test!(test_groth16_test_circuit_scale_256000, gen_test_circ, 256000);
define_test!(test_groth16_test_circuit_scale_512000, gen_test_circ, 512000);
define_test!(
