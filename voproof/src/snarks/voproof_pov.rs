...
impl<E: PairingEngine> SNARK<E> for VOProofPOV {
  ...
  fn prove(pk: &Self::PK, x: &Self::Ins, w: &Self::Wit) -> Result<Self::Pf, Error> {
          ...
          c * vector_index!(t_vec, minus_i64!(i + n, 1))
            * (vector_index!(w_vec, minus_i64!(i + n, 1))
            ...
            + c_2
              ...
              * (vector_index!(w_vec, minus_i64!(i + n, -3 * cap_c_total + n + 1))
                + range_index!(
                  1,
                  3 * cap_c_total,
            ...
            + vector_index!(w_vec, minus_i64!(i + n, -cap_c_m + n + 1))
              * vector_index!(w_vec, minus_i64!(i + n, -cap_c_m - cap_c_total + n + 1))
            - range_index!(1, cap_c_m, minus_i64!(i + n, -cap_c_m + n + 1))
              * vector_index!(w_vec, minus_i64!(i + n, -cap_c_m - 2 * cap_c_total + n + 1))
            + (power(alpha, 4) * delta!(i + n, -3 * cap_c_total + n + 1)
    ...
    define_expression_vector!(
      h_vec_1,
      i,
      -power(alpha, 5) * power(omega, 3 * cap_c_total - 1) * delta!(i - maxshift - n, 1)
        + c * vector_index!(v_vec_1, minus_i64!(i - maxshift - n, 1 - shiftlength_1))
        + c_1 * vector_index!(w_vec, minus_i64!(i - maxshift - n, 1))
        + c_10 * range_index!(1, 3 * cap_c_total, minus_i64!(i - maxshift - n, 1))
        + c_11
          * vector_index!(
            v_vec_6,
            minus_i64!(i - maxshift - n, -cap_c_m - 2 * cap_c_total + 2)
          )
        + c_12
          * vector_index!(
            v_vec_7,
        ...
        + c_12
          * vector_index!(
            v_vec_7,
            minus_i64!(i - maxshift - n, -cap_c_a - cap_c_m - cap_c_total + 2)
          )
        + c_13
          * vector_index!(
            v_vec_7,
            minus_i64!(i - maxshift - n, -cap_c_a - cap_c_m - 2 * cap_c_total + 2)
          )
        + c_14 * vector_index!(v_vec_8, minus_i64!(i - maxshift - n, 2 - 3 * cap_c_total))
        + c_15
          * vector_index!(
            v_vec_9,
            minus_i64!(i - maxshift - n, cap_c_a + cap_c_m - cap_c_total + 2)
          )
        + c_16 * vector_index!(v_vec_10, minus_i64!(i - maxshift - n, -shiftlength_4))
        + c_17 * vector_index!(v_vec_11, minus_i64!(i - maxshift - n, -shiftlength_4))
        + c_18 * vector_index!(v_vec_11, minus_i64!(i - maxshift - n, 1 - shiftlength_4))
        + c_19
          * vector_index!(
            v_vec_12,
            minus_i64!(i - maxshift - n, cap_c_m - 3 * cap_c_total)
          )
        + c_2 * vector_index!(v_vec_3, minus_i64!(i - maxshift - n, 1 - shiftlength_3))
        + c_4
          * vector_index!(
            v_vec,
            minus_i64!(i - maxshift - n, -cap_c_total - shiftlength + 1)
          )
        + c_5 * vector_index!(v_vec_2, minus_i64!(i - maxshift - n, 1 - shiftlength_2))
        + c_6 * vector_index!(v_vec_3, minus_i64!(i - maxshift - n, -shiftlength_3))
        + c_7
          * vector_index!(
            v_vec_4,
            minus_i64!(i - maxshift - n, 3 * cap_c_total - shiftlength_4)
          )
        + c_8 * vector_index!(v_vec_5, minus_i64!(i - maxshift - n, 1 - shiftlength_5))
        ...
        + z
          * (-power(alpha, 2)
            ...
            * (one!() - power(omega / z, -cap_c_a - cap_c_m + cap_c_total))
            ...
            + power(z, -cap_c_m - 2 * cap_c_total + n + 1)
              * power(omega / z, -cap_c_m + 3 * cap_c_total)
