...
#[derive(Clone, CanonicalSerialize, CanonicalDeserialize)]
pub struct HPRProof<E: PairingEngine> {pub cm_w_vec_1: Commitment<E>,
...
impl VOProofHPR {
  pub fn get_max_degree(size: HPRSize) -> usize {
    (5*(size.ncols as i64) + 2*(size.adensity as i64) + 2*(size.bdensity as i64) + 2*(size.cdensity as i64) + 2*(size.ddensity as i64) + 2) as usize
  }
}
  ...
  fn prove(pk: &Self::PK, x: &Self::Ins, w: &Self::Wit) -> Result<Self::Pf, Error> {
    ...
    sample_randomizers!(
        ...
        define_vec!(
          ...
          minus_i64!(
          i + n,
          3*cap_k + 2)) + c_10*vector_index!(
          h_vec,
          minus_i64!(
          i + n,
          cap_h + 1))*vector_index!(
          s_vec,
          i + n) + c_11*range_index!(
          1,
          n,
          minus_i64!(
          i + n,
          ...
          minus_i64!(
          i + n,
          3*cap_k + 2)) + c_4*range_index!(
          1,
          ell,
          minus_i64!(
          i + n,
          3*cap_k + 2)) + c_5*vector_index!(
          pk.u_vec,
          minus_i64!(
          i + n,
          ...
          minus_i64!(
          i + n,
          3*cap_k + 2))) + c_6*power(range_index!(
          1,
          ell,
          minus_i64!(
          i + n,
          3*cap_k + 2)), 2) + c_7*vector_index!(
          w_vec_1,
          minus_i64!(
          i + n,
        ...
        define!(
          c_14,
          power(alpha, 6)*power(omega, cap_h));
        define!(
          c_15,
          -power(alpha, 4)*mu);
        define!(
        ...
        define!(
          c_18,
          power(alpha, 6)*power(omega, cap_h + 1));
        define!(
          c_19,
          -power(alpha, 6)*beta*power(omega, cap_h));
        define!(
          c_20,
          power(alpha, 7)*power(omega, 3*cap_k + cap_s_a + cap_s_b + cap_s_c + cap_s_d));
        define!(
          c_21,
          mu*power(omega, cap_h - 1));
        define!(
          c_22,
          -power(gamma*omega, cap_h - 1));
        define!(
          c_23,
          power(alpha, 2)*power(omega, 3*cap_k + cap_s_a + cap_s_b + cap_s_c + cap_s_d));
        define!(
          c_24,
          alpha*nu*power(omega, 3*cap_k));
        define!(
          c_25,
          -alpha*power(gamma*omega, 3*cap_k));
        define!(
          c_26,
        ...
        define!(
          c_31,
          -power(omega, 5*cap_k + 2*cap_s_a + 2*cap_s_b + 2*cap_s_c + 2*cap_s_d + 2));
        define!(
          c_32,
          -power(omega, cap_h - 1));
        define!(
          c_33,
          -alpha*power(omega, 3*cap_k));
        define!(
          c_34,
        ...
        define_expression_vector!(
          ...
          minus_i64!(
          i - maxshift - n,
          3*cap_k - shiftlength_8 + 2)) + c_14*vector_index!(
          s_vec,
          minus_i64!(
          i - maxshift - n,
          1 - cap_h)) + c_15*vector_index!(
          v_vec_1,
          minus_i64!(
          i - maxshift - n,
          3*cap_k - shiftlength + 2)) + c_16*vector_index!(
          v_vec_3,
          minus_i64!(
          i - maxshift - n,
          3*cap_k - shiftlength_2 + 2)) + c_17*vector_index!(
          v_vec_5,
          minus_i64!(
          i - maxshift - n,
          -cap_k - shiftlength_4 + 1)) + c_18*vector_index!(
          v_vec_7,
          minus_i64!(
          i - maxshift - n,
          -cap_h - shiftlength_6)) + c_19*vector_index!(
          v_vec_8,
          minus_i64!(
          i - maxshift - n,
          -cap_h - shiftlength_7 + 1)) + c_2*vector_index!(
          v_vec_4,
          minus_i64!(
          i - maxshift - n,
          3*cap_k - shiftlength_3 + 2)) + c_20*vector_index!(
          r_vec_tilde,
          minus_i64!(
          i - maxshift - n,
          2 - n)) + c_21*vector_index!(
          v_vec_10,
          minus_i64!(
          i - maxshift - n,
          2 - cap_h)) + c_22*vector_index!(
          v_vec_11,
          minus_i64!(
          i - maxshift - n,
          2 - cap_h)) + c_23*vector_index!(
          v_vec_12,
          minus_i64!(
          i - maxshift - n,
          -3*cap_k - cap_s_a - cap_s_b - cap_s_c - cap_s_d + 1)) + c_24*vector_index!(
          v_vec_13,
          minus_i64!(
          i - maxshift - n,
          1 - 3*cap_k)) + c_25*vector_index!(
          v_vec_14,
          minus_i64!(
          i - maxshift - n,
          1 - 3*cap_k)) + c_26*vector_index!(
          v_vec_15,
          minus_i64!(
          i - maxshift - n,
          -3*cap_k - ell + 1)) + c_27*vector_index!(
          v_vec_16,
          minus_i64!(
          i - maxshift - n,
          3*cap_k - shiftlength_1 + 2)) + c_28*vector_index!(
          v_vec_17,
          minus_i64!(
          i - maxshift - n,
          2 - 3*cap_k)) + c_29*vector_index!(
          v_vec_18,
          minus_i64!(
          i - maxshift - n,
          -3*cap_k - cap_s_a - cap_s_b - cap_s_c - cap_s_d + 1)) + c_30*vector_index!(
          v_vec_18,
          minus_i64!(
          i - maxshift - n,
          -3*cap_k - cap_s_a - cap_s_b - cap_s_c - cap_s_d + 2)) + c_31*vector_index!(
          v_vec_19,
          minus_i64!(
          i - maxshift - n,
          -2*cap_k - cap_s_a - cap_s_b - cap_s_c - cap_s_d - 1)) + c_32*vector_index!(
          v_vec_20,
          minus_i64!(
          i - maxshift - n,
          ...
          minus_i64!(
          i - maxshift - n,
          1 - 3*cap_k)) + c_34*vector_index!(
          v_vec_22,
          minus_i64!(
          i - maxshift - n,
          -cap_s_a - cap_s_b - cap_s_c - cap_s_d + 2)) + c_9*vector_index!(
          v_vec_6,
          minus_i64!(
          i - maxshift - n,
          1 - shiftlength_5)),
        ...
        define!(
          c_35,
          one!()*(power(alpha, 6)*(omega - one!()*z)*(gamma*omega - one!()*z)*(-beta*y*power(omega/z, cap_h) + one!()*y_2 + y_1*power(omega/z, cap_h + 1) + power(omega/z, cap_h)) - power(alpha, 2)*z*power(omega/z, cap_h + 3*cap_k + 1)*(one!() - power(omega/z, -cap_h + cap_s_a + cap_s_b + cap_s_c + cap_s_d))*(gamma*omega - one!()*z) - one!()*z*(mu*(one!() - power(omega/z, cap_h))*(gamma*omega - one!()*z) - (omega - one!()*z)*(one!() - power(gamma*omega/z, cap_h))))/((omega - one!()*z)*(gamma*omega - one!()*z)));
        define!(
          c_36,
          (power(alpha, 4)*(mu*nu*one!()*y*power(z, 3*cap_k + 1)*(omega - one!()*z)*(one!() - power(z, ell)) + power(z, 3*cap_k + 2)*power(omega/z, 3*cap_k + 1)*(one!() - power(z, ell))*(one!() - power(omega/z, cap_s_a + cap_s_b + cap_s_c + cap_s_d))) + alpha*power(one!(), 2)*z*(one!() - power(z, 3*cap_k + 1))*(one!() - power(omega/z, 3*cap_k + 1)) + power(one!(), 2)*z*(one!() - power(z, cap_h))*(one!() - power(omega/z, cap_h)))/((omega - one!()*z)*(one!() - z)));
        define!(
          c_37,
          -alpha*power(one!(), 2)*z*(nu*(one!() - power(omega/z, 3*cap_k + 1))*(gamma*omega - one!()*z) - (omega - one!()*z)*(one!() - power(gamma*omega/z, 3*cap_k + 1)))/((omega - one!()*z)*(gamma*omega - one!()*z)));
        define!(
          c_38,
        ...
        define!(
          c_40,
          power(alpha, 4)*one!()*y*power(z, 3*cap_k + 1));
        define!(
          c_41,
          power(alpha, 5)*power(omega/z, 2*cap_k + cap_s_a + cap_s_b + cap_s_c + cap_s_d + 1)*(y_1*power(z, -2*cap_k + n)*(omega - one!()*z) + power(z, -3*cap_k + n + 1)*(one!() - power(omega/z, cap_k)))/(omega - one!()*z));
        define!(
          c_42,
          -power(alpha, 6)*beta*one!()*y*power(z, 3*cap_k + 1));
        define!(
          c_43,
          power(alpha, 6)*one!()*(alpha*power(omega/z, 3*cap_k + cap_s_a + cap_s_b + cap_s_c + cap_s_d)*(omega - one!()*z) + z*(one!() - z)*(one!() - power(omega/z, 3*cap_k + cap_s_a + cap_s_b + cap_s_c + cap_s_d + 1)))/(omega - one!()*z));
        define!(
          c_44,
