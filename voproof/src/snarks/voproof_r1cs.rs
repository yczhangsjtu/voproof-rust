...
#[derive(Clone, CanonicalSerialize, CanonicalDeserialize)]
pub struct R1CSProof<E: PairingEngine> {pub cm_u_vec_1: Commitment<E>,
...
impl VOProofR1CS {
  pub fn get_max_degree(size: R1CSSize) -> usize {
    (-(size.nrows as i64) + 2*(size.ncols as i64) + 2*(size.adensity as i64) + 2*(size.bdensity as i64) + 2*(size.cdensity as i64)) as usize
  }
}
  ...
  fn prove(pk: &Self::PK, x: &Self::Ins, w: &Self::Wit) -> Result<Self::Pf, Error> {
    ...
    sample_randomizers!(
        ...
        define_vec!(
          ...
          minus_i64!(
          i + n,
          cap_k + 1)) + c_10*vector_index!(
          h_vec,
          minus_i64!(
          i + n,
          3*cap_h + 1))*vector_index!(
          s_vec,
          ...
          minus_i64!(
          i + n,
          cap_k + 1)) + c_4*range_index!(
          1,
          ell_1,
          minus_i64!(
          i + n,
          cap_k + 1)) + c_5*vector_index!(
          pk.u_vec,
          minus_i64!(
          i + n,
          cap_k + 1)) + vector_index!(
          pk.y_vec,
          minus_i64!(
          i + n,
          cap_k + 1))) + c_6*power(range_index!(
          1,
          ell_1,
          minus_i64!(
          i + n,
          cap_k + 1)), 2) + c_7*vector_index!(
          u_vec_1,
          minus_i64!(
          i + n,
          -cap_h + n + 1))*vector_index!(
          u_vec_1,
          minus_i64!(
          i + n,
          -2*cap_h + n + 1)) + c_8*range_index!(
          1,
          cap_h,
          minus_i64!(
          i + n,
        ...
        define!(
          c_17,
          -power(alpha, 7)*beta*power(omega, 3*cap_h));
        define!(
          c_18,
          power(alpha, 8)*power(omega, cap_k + cap_s_a + cap_s_b + cap_s_c - 1));
        define!(
          c_19,
          -power(alpha, 6)*power(omega, 3*cap_h + ell));
        define!(
          c_20,
        ...
        define!(
          c_31,
          -power(omega, -cap_h + 2*cap_k + 2*cap_s_a + 2*cap_s_b + 2*cap_s_c));
        define!(
          c_32,
        ...
        define_expression_vector!(
          ...
          minus_i64!(
          i - maxshift - n,
          cap_k - shiftlength_7 + 1)) + c_14*vector_index!(
          v_vec_1,
          minus_i64!(
          i - maxshift - n,
          cap_k - shiftlength + 1)) + c_15*vector_index!(
          v_vec_3,
          minus_i64!(
          i - maxshift - n,
          cap_k - shiftlength_2 + 1)) + c_16*vector_index!(
          v_vec_5,
          minus_i64!(
          i - maxshift - n,
          -cap_h - shiftlength_4 + 1)) + c_17*vector_index!(
          v_vec_7,
          minus_i64!(
          i - maxshift - n,
          -3*cap_h - shiftlength_6 + 1)) + c_18*vector_index!(
          r_vec_tilde,
          minus_i64!(
          i - maxshift - n,
          2 - n)) + c_19*power_vector_index!(
          c_12,
          ell + 1,
          minus_i64!(
          i - maxshift - n,
          1 - ell)) + c_19*vector_index!(
          v_vec_18,
          minus_i64!(
          i - maxshift - n,
          2 - ell)) + c_2*vector_index!(
          v_vec_4,
          minus_i64!(
          i - maxshift - n,
          cap_k - shiftlength_3 + 1)) + c_20*vector_index!(
          v_vec_9,
          minus_i64!(
          i - maxshift - n,
          ...
          minus_i64!(
          i - maxshift - n,
          2 - 3*cap_h)) + c_22*vector_index!(
          v_vec_11,
          minus_i64!(
          i - maxshift - n,
          -cap_k - cap_s_a - cap_s_b - cap_s_c + 2)) + c_23*vector_index!(
          v_vec_12,
          minus_i64!(
          i - maxshift - n,
          ...
          minus_i64!(
          i - maxshift - n,
          2 - cap_k)) + c_25*vector_index!(
          v_vec_14,
          minus_i64!(
          i - maxshift - n,
          -cap_k - ell_1 + 2)) + c_26*vector_index!(
          v_vec_15,
          minus_i64!(
          i - maxshift - n,
          cap_k - shiftlength_1 + 1)) + c_27*vector_index!(
          v_vec_16,
          minus_i64!(
          i - maxshift - n,
          2 - 3*cap_h)) + c_28*vector_index!(
          v_vec_17,
          minus_i64!(
          i - maxshift - n,
          -3*cap_h - ell + 1)) + c_29*vector_index!(
          v_vec_19,
          minus_i64!(
          i - maxshift - n,
          -cap_k - cap_s_a - cap_s_b - cap_s_c + 2)) + c_30*vector_index!(
          v_vec_19,
          minus_i64!(
          i - maxshift - n,
          -cap_k - cap_s_a - cap_s_b - cap_s_c + 3)) + c_31*vector_index!(
          v_vec_20,
          minus_i64!(
          i - maxshift - n,
          cap_h - cap_k - cap_s_a - cap_s_b - cap_s_c)) + c_32*vector_index!(
          v_vec_21,
          minus_i64!(
          i - maxshift - n,
          2 - 3*cap_h)) + c_33*vector_index!(
          v_vec_22,
          minus_i64!(
          i - maxshift - n,
          2 - cap_k)) + c_34*vector_index!(
          v_vec_23,
          minus_i64!(
          i - maxshift - n,
        ...
        define!(
          c_38,
          -power(alpha, 4)*mu*one!()*y*power(z, cap_k));
        define!(
          c_39,
          -power(alpha, 4)*nu*one!()*y*power(z, cap_k));
        define!(
          c_40,
          power(alpha, 4)*one!()*y*power(z, cap_k));
        define!(
          c_41,
          power(alpha, 5)*(alpha*one!()*power(omega/z, 3*cap_h)*(omega*power(omega/z, ell) - one!()*z) + y_1*power(z, -2*cap_h + n)*power(omega/z, -cap_h + cap_k + cap_s_a + cap_s_b + cap_s_c)*(omega - one!()*z) + power(z, -3*cap_h + n + 1)*power(omega/z, -cap_h + cap_k + cap_s_a + cap_s_b + cap_s_c)*(one!() - power(omega/z, cap_h)))/(omega - one!()*z));
        define!(
          c_42,
          -power(alpha, 7)*beta*one!()*y*power(z, cap_k));
        define!(
          c_43,
          power(alpha, 7)*one!()*(alpha*power(omega/z, cap_k + cap_s_a + cap_s_b + cap_s_c - 1)*(omega - one!()*z) + z*(one!() - z)*(one!() - power(omega/z, cap_k + cap_s_a + cap_s_b + cap_s_c)))/(omega - one!()*z));
        define!(
          c_44,
          power(z, n)*power(omega/z, cap_k + cap_s_a + cap_s_b + cap_s_c)*(one!() - power(omega/z, -cap_h + cap_k + cap_s_a + cap_s_b + cap_s_c + 1))/(omega - one!()*z));
        define!(
          c_45,
          -power(z, -cap_d));
        define!(
